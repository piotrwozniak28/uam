...
do
    echo "Adding dummy column to ${TABLE_DEFINITIONS_DIR}/tdef_tpcds_ext_noauto_${table_name}.json..."
    jq '.schema.fields += [{"name": "test", "type": "BOOL"}]' ${TABLE_DEFINITIONS_DIR}/tdef_tpcds_ext_noauto_${table_name}.json | sponge ${TABLE_DEFINITIONS_DIR}/tdef_tpcds_ext_noauto_${table_name}.json

    echo "Replacing fieldDelimiter for ${table_name}..."
