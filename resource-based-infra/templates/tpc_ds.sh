...
gcloud storage cp gs://bkt-tpcds-seed-100-asd356y4h68f213/DSGen-software-code-4.0.0.zip . --billing-project=prj-tpcds-qpzo1
...
tpcds_sort
gcloud storage cp -r . gs://bkt-tpcds-qpzo1
